    ...
    public WordPuzzle(boolean [][] blackBoxes){
        ...
        for(int rCount = 0; rCount < r; rCount++){
            for(int cCount = 0; cCount < c; cCount++){
                if(toBeLabeled(rCount, cCount, blackBoxes)){
                    puzzle[rCount][cCount] = new Box(blackBoxes[rCount][cCount], counter);
                    counter++;
                }
                else{
                    puzzle[rCount][cCount] = new Box(blackBoxes[rCount][cCount], 0);
                }
